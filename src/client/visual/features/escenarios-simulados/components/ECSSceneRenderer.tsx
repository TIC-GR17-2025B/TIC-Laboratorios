...
const ECSSceneRenderer: React.FC = () => {
  ...
  const [menuOpenForEntity, setMenuOpenForEntity] = useState<number | null>(
    null,
  );
  ...
  const getMenuOptions = (
    ...
    const selectedEntity = processedEntities.find(
      (e) => e.entidadId === menuOpenForEntity,
    );
